    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <p className="text-[#ADB7BE] text-base mb-6 sm:text-lg lg:txt-xl">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima hic
            deserunt in perferendis nesciunt, omnis, quod accusantium
            praesentium, aut quis qui ducimus maiores dolorem. Reprehenderit
            placeat a eaque ipsam id.
          </p>
          <div>
